...
Ridge_rsq = RidgeLasso_test(Ridge_model,Ridge_opt_lambda,year_20_strikers,striker_attributes)
Ridge_rsq

Ridge_result = RidgeRegression(all_year_midfielders,midfielder_attributes)
Ridge_model = Ridge_result[[1]]
Ridge_opt_lambda = Ridge_result[[2]]
Ridge_rsq = RidgeLasso_test(Ridge_model,Ridge_opt_lambda,year_20_midfielders,midfielder_attributes)
Ridge_rsq

Ridge_result = RidgeRegression(all_year_defenders,defenders_attributes)
Ridge_model = Ridge_result[[1]]
Ridge_opt_lambda = Ridge_result[[2]]
Ridge_rsq = RidgeLasso_test(Ridge_model,Ridge_opt_lambda,year_20_strikers,defenders_attributes)
Ridge_rsq
```